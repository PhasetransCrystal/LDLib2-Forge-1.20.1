 ...
 *
 * <p>
 * TODO: Implement these menu items for your UI framework.
 * </p>
 */
public final class ContextualMenuHelpers {
    ...
    // internal static ContextualMenuItem duplicateItem = new(ContextualMenuCategory.RenameDuplicateDelete,
    // "Duplicate");
    ...
    // internal static ContextualMenuItem createPlacematItem = new(ContextualMenuCategory.OrganizationalElements,
    // "Create Placemat");
    // internal static ContextualMenuItem createLocalSubgraphFromSelectionItem = new(ContextualMenuCategory.Conversions,
    // "Create Local Subgraph from Selection");
    // internal static ContextualMenuItem frameSelectionItem = new(ContextualMenuCategory.Modifications, "Frame
    // Selection");
    // internal static ContextualMenuItem colorItem = new(ContextualMenuCategory.Modifications, "Color");
    // internal static ContextualMenuItem alignAndDistributeElementsItem = new(ContextualMenuCategory.Organization,
    ...
    // internal static ContextualMenuItem createStickyNoteItem = new(ContextualMenuCategory.OrganizationalElements,
    // "Create Sticky Note");
    // internal static ContextualMenuItem createEmptyLocalSubgraphItem =
    // new(ContextualMenuCategory.OrganizationalElements, "Create Empty Local Subgraph");
    // internal static ContextualMenuItem selectAllItem = new(ContextualMenuCategory.Organization, "Select All");
    // internal static ContextualMenuItem showOverlayMenuItem = new(ContextualMenuCategory.External, "Show Overlay
    // Menu");
    //
    // // Node menu items:
    ...
    // internal static ContextualMenuItem disconnectAllWiresItem = new(ContextualMenuCategory.Modifications, "Disconnect
    // All Wires");
    // internal static ContextualMenuItem toggleCollapseItem = new(ContextualMenuCategory.Modifications, "Toggle
    // Collapse");
    // internal static ContextualMenuItem deleteAndReconnectItem = new(ContextualMenuCategory.RenameDuplicateDelete,
    // "Delete and reconnect");
    //
    // // State menu items:
    // internal static ContextualMenuItem createTransitionMenuItem = new(ContextualMenuCategory.FunctionalElements,
    // "Create Transition");
    // internal static ContextualMenuItem createLocalTransitionMenuItem = new(ContextualMenuCategory.FunctionalElements,
    // "Create Local Transition");
    // internal static ContextualMenuItem createOnEnterTransitionMenuItem =
    // new(ContextualMenuCategory.FunctionalElements, "Create OnEnter Transition");
    // internal static ContextualMenuItem createSelfTransitionMenuItem = new(ContextualMenuCategory.FunctionalElements,
    // "Create Self Transition");
    // internal static ContextualMenuItem setAsDefaultStateMenuItem = new(ContextualMenuCategory.Modifications, "Set
    // Default State");
    //
    // // Subgraph menu items:
    // internal static ContextualMenuItem extractContentsToPlacematItem = new(ContextualMenuCategory.Conversions,
    // "Extract Contents to Placemat");
    // internal static ContextualMenuItem openLocalSubgraphItem = new(ContextualMenuCategory.AssetManagement, "Open
    // Local Subgraph");
    // internal static ContextualMenuItem openAssetSubgraphItem = new(ContextualMenuCategory.AssetManagement, "Open
    // Asset Subgraph");
    // internal static ContextualMenuItem unpackToLocalSubgraphItem = new(ContextualMenuCategory.AssetManagement,
    // "Unpack to Local Subgraph");
    // internal static ContextualMenuItem findAssetInProjectItem = new(ContextualMenuCategory.AssetManagement, "Find
    // Asset in Project");
    // internal static ContextualMenuItem convertToAssetSubgraphItem = new(ContextualMenuCategory.AssetManagement,
    // "Convert to Asset Subgraph");
    //
    ...
    // internal static ContextualMenuItem convertToConstantItem = new(ContextualMenuCategory.Conversions, "Convert to
    // Constant");
    // internal static ContextualMenuItem convertToVariableItem = new(ContextualMenuCategory.Conversions, "Convert to
    // Variable");
    //
    // // Blackboard menu items:
    // internal static ContextualMenuItem createVariableItem = new(ContextualMenuCategory.FunctionalElements, "Create
    // Variable");
    // internal static ContextualMenuItem createGroupItem = new(ContextualMenuCategory.FunctionalElements, "Create
    // Group");
    //
    // // Ports menu items:
    // internal static ContextualMenuItem addNodeFromPortItem = new(ContextualMenuCategory.FunctionalElements, "Add Node
    // from port");
    // internal static ContextualMenuItem createVariableFromPortItem = new(ContextualMenuCategory.FunctionalElements,
    // "Create Variable from port");
    ...
    //
    // // Wire menu items:
    // internal static ContextualMenuItem insertNodeItem = new(ContextualMenuCategory.FunctionalElements, "Insert
    // Node");
    // internal static ContextualMenuItem insertJunctionPointItem = new(ContextualMenuCategory.FunctionalElements,
    // "Insert Junction Point");
    // internal static ContextualMenuItem convertToPortalsItem = new(ContextualMenuCategory.Conversions, "Convert to
    // Portals");
    ...
    // internal static ContextualMenuItem insertBlockAboveItem = new(ContextualMenuCategory.FunctionalElements, "Insert
    // Block Above");
    // internal static ContextualMenuItem insertBlockBelowItem = new(ContextualMenuCategory.FunctionalElements, "Insert
    // Block Below");
    // internal static ContextualMenuItem convertToBlockSubgraphItem = new(ContextualMenuCategory.Conversions, "Convert
    // to Block Subgraph");
    //
    ...
    //
    // // Placemat menu items:
    // internal static ContextualMenuItem deleteAndSelectContentsItem =
    // new(ContextualMenuCategory.RenameDuplicateDelete, "Delete and Select Contents");
    // internal static ContextualMenuItem smartResizeItem = new(ContextualMenuCategory.Modifications, "Smart Resize");
    // internal static ContextualMenuItem reorderPlacematItem = new(ContextualMenuCategory.Modifications, "Reorder
    // Placemat");
    // internal static ContextualMenuItem selectAllPlacematContentsItem = new(ContextualMenuCategory.Organization,
    // "Select All Placemat Contents");
    //
    // // Portals menu items:
    // internal static ContextualMenuItem createOppositePortalItem = new(ContextualMenuCategory.Conversions, "Create
    // Opposite Portal");
    // internal static ContextualMenuItem revertToWireItem = new(ContextualMenuCategory.Conversions, "Revert to Wire");
    // internal static ContextualMenuItem revertAllToWiresItem = new(ContextualMenuCategory.Conversions, "Revert All to
    // Wire");
}
