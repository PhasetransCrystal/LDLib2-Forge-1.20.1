 ...
 *
 * <p>
 * Variable nodes represent a reference to a declared {@link IVariable} in the graph.
 ...
 * The variable node is an instance of the declared {@link IVariable} and appears in the graph.
 * </p>
 */
public interface IVariableNode extends INode {
     ...
     *
     * <p>
     * This property returns the variable that this node references. The variable defines the node's data type
     * and determines the port behavior. The returned variable is declared in the graph's Blackboard and shared
     * across all variable nodes that reference it.
     * </p>
     *
