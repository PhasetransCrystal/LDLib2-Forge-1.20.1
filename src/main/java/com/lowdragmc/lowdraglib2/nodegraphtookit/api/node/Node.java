 ...
 *
 * <p>
 * Inherit from this class to define custom node types that appear in the graph. The {@link Node} class provides
 ...
 * context nodes, and subgraph nodes.
 * </p>
 *
 * <p>
 * To create a custom node, derive from {@link Node}, define its input and output ports using a port builder
 * in {@link #onDefinePorts(IPortDefinitionContext)}, and define its options in
 * {@link #onDefineOptions(IOptionDefinitionContext)}.
 * </p>
 *
 * <p>
 * This class is used in combination with other types like {@link INode}, {@link IPort}, and
 * {@link com.lowdragmc.lowdraglib2.nodegraphtookit.api.graph.Graph} to construct and manage node-based workflows.
 * </p>
 *
 * @see INode
 * @see IVariableNode
...
public abstract class Node implements INode {
     ...
     *
     * <p>
     * This method calls both {@link #onDefineOptions(IOptionDefinitionContext)} and
     * {@link #onDefinePorts(IPortDefinitionContext)} to allow custom definition of the node.
     * </p>
     */
     ...
     *
     * <p>
     * This method is called before {@link #onDefinePorts(IPortDefinitionContext)}. Override this method to add node
     * options
     * using the provided {@link IOptionDefinitionContext}.
     * </p>
     *
     ...
     *
     * <p>
     * This method is called after {@link #onDefineOptions(IOptionDefinitionContext)} and is used to declare the
     * structure
     * of the node's connectivity. Use the provided {@link IPortDefinitionContext} to define input and output ports
     * using a
     * builder pattern.
     * </p>
     *
