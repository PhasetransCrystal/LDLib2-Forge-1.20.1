 ...
 *
 * <p>
 * Use constant nodes to represent a static, predefined value in the graph. This value remains unchanged
 ...
 * The {@link #getDataType()} property identifies the constant's type.
 * </p>
 */
public interface IConstantNode extends INode, IFieldConstantConfigurable {
     ...
     * such as {@code Float}, {@code Integer}, {@code String}, or a custom type.
     * </p>
     *
     ...
     * and conversion internally. If the value cannot be cast to the specified type, the method returns {@code null}.
     * </p>
     *
