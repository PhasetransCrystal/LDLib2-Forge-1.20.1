...
public interface IOptionBuilder<T extends IOptionBuilder<T>> {
     ...
     *
     * <p>
     * This method is optional. All options are automatically built when the node's
     * {@link Node#onDefineOptions(IOptionDefinitionContext)} method completes.
     * </p>
     *
     * <p>
     ...
     * (calling {@link Node#onDefineOptions(IOptionDefinitionContext)}) is used as the default display name.
     * </p>
     *
