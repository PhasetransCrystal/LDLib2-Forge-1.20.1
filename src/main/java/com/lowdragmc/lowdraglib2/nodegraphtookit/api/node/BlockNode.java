 ...
 *
 * <p>
 * Blocks behave like regular nodes (have ports, options, wires) but they are not
 * top-level graph nodes; they are reachable only through their parent context. A block is
 * compatible with a context when either:
 * </p>
 * <ul>
 ...
 *
 * <p>
 * Subclass and annotate with {@link NodeAttribute}. The framework auto-creates the
 * backing {@link com.lowdragmc.lowdraglib2.nodegraphtookit.model.node.CustomBlockNodeModelImpl}
 * when the block is inserted into a context.
 * </p>
 */
