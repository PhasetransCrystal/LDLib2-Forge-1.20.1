 ...
 *
 * <p>
 * This interface supports a builder pattern, where each method returns the builder instance, allowing chained
 * configuration of port settings before final construction using {@link #build()}.
 * </p>
 *
 * <p>
 * Use derived interfaces such as {@link IInputPortBuilder} or {@link IOutputPortBuilder} to build specific port types.
 * </p>
 */
public interface IPortBuilder<T extends IPortBuilder<T>> {
     ...
     * The builder captures options such as the port's data type, display name, connector style, and default value, if
     * applicable.
     * This method finalizes the port and adds it to the graph. After calling {@code build()}, do not modify the builder
     * further.
     ...
     *
     * <p>
     * Use this method to assign a custom label to the port. This label appears in the user interface next to the port
     ...
     * If not set, the port name passed during creation is used as the fallback display name.
     * </p>
     *
     ...
     *
     * <p>
     * Use this method to control the appearance of the port's connector in the UI. The {@link PortConnectorUI} enum
     ...
     * Call this method before {@link #build()} to ensure the selected style is applied to the constructed port.
     * </p>
     *
