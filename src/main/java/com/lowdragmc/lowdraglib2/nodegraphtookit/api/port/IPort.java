...
public interface IPort {
     ...
     * Use {@link PortDirection#INPUT} or {@link PortDirection#OUTPUT} to determine behavior.
     * </p>
     *
     ...
     *
     * <p>
     * This method is intended for editor-time inspection of an input port’s value, configured
     * through a field displayed in the UI. If the port is connected, the field is hidden and no
     * value is available, so the method returns {@code error}.
     * </p>
     *
     * <p>
     * If the value was never explicitly set, this method still returns {@code success}, and
     * {@code outValue} will contain the default value for the requested type.
     * </p>
     *
     */
