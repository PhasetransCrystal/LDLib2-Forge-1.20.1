...
/**
 * With {@code @RPCPacket}, you can declare a static method ANYWHERE in your codebase and treat it as a network packet
 * handler.
 * The annotated method itself becomes the packet’s execution target, and its parameters represent the data transferred
 ...
 *
 * <li>`RPCSender` (optional): If declared as the first parameter, LDLib2 injects sender-side information, allowing you
 * to distinguish whether the call is executed on the client or the server.</li>
 *
