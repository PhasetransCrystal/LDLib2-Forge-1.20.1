 ...
 *
 * <p>
 * Each schema-evolution test node is its own top-level public file so it can be instantiated
 * via {@code Class.getConstructor()} reflection in {@code GraphModel.findNodeByClassName}.
 * </p>
 */
public final class SchemaEvolutionTestNodes {
    ...
    public record EvCodecValueA(int a, String b) {
        ...
        public static final Codec<EvCodecValueA> CODEC = RecordCodecBuilder.create(i -> i.group(
                ...
                Codec.STRING.fieldOf("b").forGetter(EvCodecValueA::b)).apply(i, EvCodecValueA::new));
    }
    ...
    public record EvCodecValueB(double x, java.util.List<Integer> ys) {
        ...
        public static final Codec<EvCodecValueB> CODEC = RecordCodecBuilder.create(i -> i.group(
                ...
                Codec.list(Codec.INT).fieldOf("ys").forGetter(EvCodecValueB::ys)).apply(i, EvCodecValueB::new));
    }
}
