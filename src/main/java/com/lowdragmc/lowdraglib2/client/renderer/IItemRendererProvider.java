...
public interface IItemRendererProvider {
     ...
     * {@link com.lowdragmc.lowdraglib2.core.mixins.ItemRendererMixin#injectRenderItem(ItemStack, ItemDisplayContext, boolean, PoseStack, MultiBufferSource, int, int, BakedModel, CallbackInfo)}
     */
