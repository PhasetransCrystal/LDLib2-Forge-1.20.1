 ...
 * This annotation is used to mark a field to be saved to the drop item. However, it also require additional code work
 * before using it.
 * 
 * <pre>
 * 
 ...
 * </pre>
 * 
 * After the above setup, the value of `itemStack` in the MyBlockEntity will be stored in the itemstack while breaking
 * and clone.
