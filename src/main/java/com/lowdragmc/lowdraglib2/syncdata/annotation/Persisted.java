...
public @interface Persisted {
     ...
     * It is very useful for `final` instance which doesn't allow new instance creation. If the filed set `subPersisted
     * = true`, Ldlib2 will do:
     * <li>if the field inherits from {@link net.minecraftforge.common.util.INBTSerializable}, it will try to use its
     * api for serialization.</li>
