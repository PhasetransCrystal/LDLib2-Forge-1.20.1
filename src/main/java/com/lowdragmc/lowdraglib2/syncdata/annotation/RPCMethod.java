...
/**
 * Annotate a method, you can send RPC packet between server and remote. You are free to define the parameters of the
 * methods long as the parameters support sync, and send rpc anywhere in your class.
 ...
 * </pre>
 *
 * <li>{@link IRPCManagedHolder#rpcToTracking(IManaged, String, Object...)}: send to all remote players if this chunk is
 * loaded(tracked) in their remotes.</li>
