...
// if (modularUI == null) {
// return new UiSnapshot(null, context.screenClass(), DRIVER_ID, List.of(), List.of(), null, null, null, null,
// Map.of());
// }
//
...
//
// return new UiActionabilityResult(actionable, visible, enabled, supported, actionable ? null : "not_actionable",
// Map.of());
// }
//
//
